window.WORKPANEL_ISSUES = [
  {
    ...
    "acceptance": [
      ...
      {
        "label": "E2E verifies checkout and confirmation totals",
        "done": true
      },
      {
        "label": "Diff contains no payment gateway contract change",
        "done": false
      },
      {
        "label": "Reviewer confirms ADR-1842-2",
        "done": false
      }
    ],
    "signals": {
  ...
  },
  {
    ...
    "acceptance": [
      {
        "label": "Tenant isolation unit tests pass",
        "done": false
      },
      {
        "label": "Browser multi-tab regression passes",
        "done": false
      },
      {
        "label": "Auth telemetry does not log raw token data",
        "done": true
      },
      {
        "label": "Security reviewer signs off",
        "done": false
      }
    ],
    "signals": {
  ...
  },
  {
    ...
    "acceptance": [
      {
        "label": "State transition test covers resolved incidents",
        "done": true
      },
      {
        "label": "Manual screenshot captured for active and resolved states",
        "done": true
      },
      {
        "label": "No cache key change for public status pages",
        "done": true
      },
      {
        "label": "Merge conflict check is clean",
        "done": true
      }
    ],
    "signals": {
  ...
  },
  {
    ...
    "acceptance": [
      {
        "label": "Fixture with duplicate rows fails before write",
        "done": false
      },
      {
        "label": "Existing upsert integration remains green",
        "done": true
      },
      {
        "label": "Import error includes row-level evidence",
        "done": false
      },
      {
        "label": "Migration impact documented",
        "done": false
      }
    ],
    "signals": {
  ...
  },
  {
    ...
    "acceptance": [
      {
        "label": "Drag between lanes updates both counts",
        "done": true
      },
      {
        "label": "Undo drag restores source and target counts",
        "done": false
      },
      {
        "label": "Selector memoization benchmark remains stable",
        "done": false
      },
      {
        "label": "Visual regression is reviewed",
        "done": false
      }
    ],
    "signals": {
  ...
  },
  {
    ...
    "acceptance": [
      {
        "label": "Backfill path supports old manifests",
        "done": true
      },
      {
        "label": "CSV metadata includes original timezone",
        "done": true
      },
      {
        "label": "Scheduler regression passes for DST boundary",
        "done": true
      },
      {
        "label": "Customer support note is attached",
        "done": true
      }
    ],
    "signals": {
